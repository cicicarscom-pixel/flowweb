...
export default function IsletmemPage() {
 ...
 <div className="bg-[#2A2631] border border-[#22B573]/30 rounded-2xl p-6 relative overflow-hidden" data-purpose="balance-card">
 {/* Background Glow */}
 <div className="absolute inset-0 bg-gradient-to-r from-[#22B573]/5 to-transparent pointer-events-none"></div>
 ...
 <div className="border-t border-[#3A3540] border-dashed w-full"></div>
 <div className="border-t border-[#3A3540] border-dashed w-full"></div>
 <div className="border-t border-[#3A3540] border-dashed w-full"></div>
 <div className="border-t border-[#3A3540] border-dashed w-full"></div>
 <div className="border-t border-[#3A3540] border-dashed w-full"></div>
 ...
 {/* Y-Axis Labels */}
 <div className="absolute right-0 top-0 bottom-0 flex flex-col justify-between text-[10px] text-on-surface-variant text-right pr-2 font-mono pb-1 z-20 bg-[#2A2631]/80 pl-2">
 <span>₺4.000</span>
 <span>₺0</span>
 <span>-₺4.000</span>
 <span>-₺8.000</span>
 ...
 <stop offset="0%" stopColor="#22B573" stopOpacity="0.3"></stop>
 <stop offset="50%" stopColor="#22B573" stopOpacity="1"></stop>
 <stop offset="100%" stopColor="#22B573" stopOpacity="1"></stop>
 </linearGradient>
 <linearGradient id="fillGradient" x1="0%" x2="0%" y1="0%" y2="100%">
 <stop offset="0%" stopColor="#22B573" stopOpacity="0.2"></stop>
 <stop offset="100%" stopColor="#22B573" stopOpacity="0"></stop>
 </linearGradient>
 </defs>
 {/* Fill Area */}
 ...
 {/* End Dot */}
 <circle cx="480" cy="130" fill="#22B573" r="4"></circle>
 </svg>
 </div>
 </div>
 </div>
 ...
 <div className="w-12 h-12 rounded-xl bg-[#11241C] flex items-center justify-center text-[#22B573] shrink-0 border border-[#1A3828]">

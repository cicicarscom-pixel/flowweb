        ...
        <div className="col-span-7 bg-surface-container border border-outline-variant/10 rounded-xl p-card-padding">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between p-3 rounded-lg hover:bg-surface-container-high transition-colors group border-t border-outline-variant/5">
              ...
              <button className="px-4 py-1.5 border border-blue-500/30 rounded-full text-blue-400 font-label-sm text-label-sm hover:bg-blue-500/10 transition-colors">Analize Git</button>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-center justify-between border-t border-outline-variant/5 pt-4">
              <div className="flex items-center gap-3 w-1/4">
                <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-blue-500 font-bold">
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-red-500 to-yellow-500">G</span>
                </div>
              ...
              <div className="w-1/4">
                <div className="font-label-md text-label-md text-on-surface flex items-center gap-1">4,8 <span className="text-yellow-400 text-xs">★★★★★</span></div>

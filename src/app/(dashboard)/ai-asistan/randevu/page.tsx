    ...
    <div className="flex-1 overflow-y-auto p-6 flex flex-col xl:flex-row gap-6 relative">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            <h1 className="text-2xl font-bold text-white mb-1">Randevu Oluştur</h1>
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-4">
            <button className="w-8 h-8 flex items-center justify-center rounded bg-app-input border border-app-border text-app-text hover:text-white transition-colors">
              <i className="fa-solid fa-chevron-left"></i>
            </button>
            <button className="flex items-center justify-between gap-4 px-4 py-1.5 rounded bg-app-input border border-app-border text-white min-w-[150px]">
          ...
          <div className="flex gap-2 overflow-x-auto pb-2">
            ...
            <button className="relative flex-1 min-w-[70px] max-w-[100px] flex flex-col items-center justify-center py-3 rounded-xl border border-app-primary bg-[#0f2e21] transition-colors">
        ...
        <div className="bg-app-card rounded-xl border border-app-border flex-1 flex flex-col">
          <div className="p-4 border-b border-app-border flex justify-between items-center">
            <h2 className="font-bold text-white">Günlük Müsaitlik</h2>
          ...
          <div className="p-6 space-y-8 flex-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="w-24 shrink-0">
                <div className="font-semibold text-white">Sabah</div>
                <div className="text-xs text-app-textDark">(08:00 - 12:00)</div>
              </div>
              <div className="flex-1 flex flex-wrap gap-2">
                <button className="px-4 py-2 rounded-lg bg-[#184834] text-white border border-[#235e46]">08:00</button>
                <button className="px-4 py-2 rounded-lg bg-[#184834] text-white border border-[#235e46]">08:30</button>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="w-24 shrink-0">
                <div className="font-semibold text-white">Öğle</div>
              ...
              <div className="flex-1 flex flex-wrap gap-2">
                ...
                <button className="px-4 py-2 rounded-lg bg-[#184834] text-white border border-[#235e46]">14:00</button>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="w-24 shrink-0">
                <div className="font-semibold text-white">Akşam</div>
              ...
              <div className="flex-1 flex flex-wrap gap-2">
                ...
                <button className="px-4 py-2 rounded-lg bg-[#184834] text-white border border-[#235e46]">20:00</button>
      ...
      <div className="w-full xl:w-[380px] shrink-0 flex flex-col gap-6">
        ...
        <div className="bg-app-card rounded-xl border border-app-border flex flex-col">
          <div className="p-4 border-b border-app-border flex items-center gap-2">
            ...
            <h2 className="font-bold text-white">Randevu Detayları</h2>
          </div>
          <div className="p-5 space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input 
                  className="w-full bg-app-input border border-app-border text-white rounded-lg pl-3 pr-10 py-2.5 focus:ring-1 focus:ring-app-primary focus:border-app-primary outline-none" 
                  readOnly 
                  type="text" 
            ...
            <div>
              ...
              <input 
                className="w-full bg-app-input border border-app-border text-white placeholder-app-textDark rounded-lg px-3 py-2.5 focus:ring-1 focus:ring-app-primary focus:border-app-primary outline-none" 
            ...
            <div>
              ...
              <textarea 
                className="w-full bg-app-input border border-app-border text-white placeholder-app-textDark rounded-lg px-3 py-2.5 focus:ring-1 focus:ring-app-primary focus:border-app-primary outline-none resize-none" 
            ...
            <div className="flex gap-3 pt-2">
              <button className="px-4 py-2.5 rounded-lg border border-app-border text-app-text hover:bg-app-hover hover:text-white transition-colors w-1/3 text-center" type="button">
                Temizle
              </button>
              <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-app-primary text-white hover:bg-app-primaryHover transition-colors font-medium" type="button">
        ...
        <div className="bg-app-card rounded-xl border border-app-border flex flex-col flex-1 min-h-[250px]">
          <div className="p-4 border-b border-app-border flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-bold text-white">Yaklaşan Randevular</h2>
            </div>
          ...
          <div className="p-2 space-y-1 overflow-y-auto">
            ...
            <div className="flex items-center gap-3 p-3 rounded-lg hover:bg-app-hover group transition-colors cursor-pointer">
              <div className="w-12 h-12 rounded bg-app-input border border-app-border flex flex-col items-center justify-center shrink-0">
                <span className="text-lg font-bold text-white leading-none mb-0.5">03</span>
                <span className="text-[10px] text-app-text uppercase tracking-wide">Tem</span>
              </div>
              <div className="flex-1 min-w-0">
                <div className="font-medium text-white truncate">ABC Teknoloji A.Ş.</div>
                <div className="text-xs text-app-text truncate">14:00 - 15:00</div>
              </div>
              <button className="text-app-textDark hover:text-white p-2 opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            <div className="flex items-center gap-3 p-3 rounded-lg hover:bg-app-hover group transition-colors cursor-pointer">
              <div className="w-12 h-12 rounded bg-app-input border border-app-border flex flex-col items-center justify-center shrink-0">
                <span className="text-lg font-bold text-white leading-none mb-0.5">04</span>
                <span className="text-[10px] text-app-text uppercase tracking-wide">Tem</span>
              </div>
              <div className="flex-1 min-w-0">
                <div className="font-medium text-white truncate">Mehmet Yılmaz</div>
            ...
            <div className="flex items-center gap-3 p-3 rounded-lg hover:bg-app-hover group transition-colors cursor-pointer">
              <div className="w-12 h-12 rounded bg-app-input border border-app-border flex flex-col items-center justify-center shrink-0">
                <span className="text-lg font-bold text-white leading-none mb-0.5">06</span>
                <span className="text-[10px] text-app-text uppercase tracking-wide">Tem</span>
              </div>
              <div className="flex-1 min-w-0">
                <div className="font-medium text-white truncate">XYZ İnşaat Ltd. Şti.</div>

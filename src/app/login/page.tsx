      ...
      <div className="flex-1 relative z-10 flex flex-col items-center justify-center p-6 md:p-12 lg:p-24 overflow-y-auto">
        <div className="w-full max-w-[420px] animate-fade-in-up">
          ...
          <button 
            ...
            className={`w-full flex items-center justify-center gap-3 bg-white text-[#07090E] font-bold py-3.5 px-4 rounded-xl transition-all hover:scale-[1.02] shadow-[0_0_15px_rgba(255,255,255,0.1)] mb-6 relative overflow-hidden group ${googleLoading ? 'opacity-70 cursor-not-allowed hover:scale-100' : 'hover:bg-gray-100'}`}
          >

...
export default function AiAsistanPage() {
  ...
  return (
    <div className="p-6 flex-1 max-w-[1400px] mx-auto w-full">
      ...
      <Link href="/ai-asistan/isletme-hizmetleri" className="block p-6 bg-[#1c1b1d] border border-[#27272a] rounded-xl flex items-center justify-between group cursor-pointer hover:bg-[#27272a] transition-all">
      <div className="flex items-center gap-4">

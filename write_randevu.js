...
const CARD_COLORS = [
  { bg: 'rgba(34,181,115,0.1)', border: 'rgba(34,181,115,0.3)', text: '#22B573', icon: '??' },
  ...
  { bg: 'rgba(255,122,89,0.1)', border: 'rgba(255,122,89,0.3)', text: '#FF7A59', icon: '???' },
];
...
export default function RandevuClient({ initialAppointments, services, merchantId, today }: { initialAppointments: any[], services: any[], merchantId: string, today: string }) {
  ...
  const monthNames = ["Ocak", "Þubat", "Mart", "Nisan", "Mayýs", "Haziran", "Temmuz", "Aðustos", "Eylül", "Ekim", "Kasým", "Aralýk"];
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 32 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 13, color: "var(--text-secondary)", margin: 0, marginTop: 4 }}>Tüm randevularýnýz sevimli asistanýnýzýn kontrolünde! ?</p>
          </div>
        </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: 32 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16, marginTop: 10 }}>
            <h3 style={{ fontSize: 16, fontWeight: 700, color: "#fff", margin: "0 0 8px 0" }}>?? {selectedDate.split('-').reverse().join('.')} Randevularý</h3>
            ...
            {appointments.length === 0 ? (
              <div className="glass" style={{ borderRadius: 24, padding: "40px", textAlign: "center", border: "1px dashed rgba(255,255,255,0.1)" }}>
                ...
                <p style={{ color: "var(--text-secondary)", fontSize: 14, fontWeight: 600, marginTop: 16 }}>Bugün için henüz planlanmýþ bir randevu yok.</p>
              </div>
            ) : (
                  ...
                  <div key={appt.id} style={{ display: "flex", gap: 16 }}>
                    ...
                    onMouseLeave={e => e.currentTarget.style.transform = "translateX(0)"}>
                      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                        ...
                        <div>
                          <h4 style={{ fontSize: 15, fontWeight: 700, color: "#fff", margin: "0 0 4px 0" }}>{appt.customer_name || 'Ýsimsiz'}</h4>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <div className="glass" style={{ borderRadius: 24, padding: "24px", border: "1px solid rgba(255,255,255,0.06)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
              <h3 style={{ fontSize: 14, fontWeight: 700, color: "#fff", margin: 0 }}>?? Günlük Yoðunluk Haritasý</h3>
              <div style={{ display: "flex", gap: 12 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                  ...
                  <span style={{ fontSize: 10, fontWeight: 700, color: "var(--text-secondary)" }}>BOÞ</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-around", paddingBottom: 6 }}>
                ...
                <span style={{ fontSize: 10, fontWeight: 700, color: "var(--text-secondary)", textAlign: "right" }}>ÖÐLE</span>
                <span style={{ fontSize: 10, fontWeight: 700, color: "var(--text-secondary)", textAlign: "right" }}>AKÞAM</span>
              </div>
            ...
            <div style={{ marginTop: 24, padding: "16px", background: "rgba(255,122,89,0.05)", borderRadius: 16, border: "1px dashed rgba(255,122,89,0.3)", display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <p style={{ fontSize: 12, color: "rgba(255,255,255,0.7)", margin: 0, lineHeight: 1.5 }}>
                Ai asistanýnýz, bu takvimi dikkate alarak müþterilerinizle yazýþýr ve boþ saatlerinize otomatik randevu planlar.
              </p>
            </div>
        ...
        <div style={{
          ...
          <div className="glass" style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginBottom: 28 }}>
              ...
              <p style={{ fontSize: 13, color: "var(--text-secondary)", margin: "4px 0 0 0" }}>Manuel olarak takvime bir kayýt girin</p>
            </div>

            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <div>
                <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "var(--text-secondary)", marginBottom: 8, paddingLeft: 4 }}>Müþteri Adý</label>
                <input 
                  type="text" 
                  value={newAppt.name}
                  onChange={e => setNewAppt({...newAppt, name: e.target.value})}
                  placeholder="Örn: Ahmet Yýlmaz"
              ...
              <div>
                <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "var(--text-secondary)", marginBottom: 8, paddingLeft: 4 }}>Telefon Numarasý</label>
                <input 
                  type="text" 
                  value={newAppt.phone}

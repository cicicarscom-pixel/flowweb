    ...
    <div className="flex-1 flex flex-col h-full overflow-hidden" data-purpose="main-content">
      ...
      <header className="px-8 py-6 flex items-center justify-between flex-shrink-0" data-purpose="header">
        ...
        <div className="flex items-center gap-4">
          {/* Notifications */}
          <button className="relative p-2.5 rounded-xl bg-[#1A1C21] border border-[#2A2F3A] text-[#94A3B8] hover:text-[#E2E8F0] transition-colors">
          ...
          <div className="flex items-center gap-3 bg-[#1A1C21] border border-[#2A2F3A] rounded-xl px-4 py-2.5 cursor-pointer hover:bg-[#23262D] transition-colors">
            ...
            <i className="fa-regular fa-calendar text-[#94A3B8]"></i>
          </div>
          
          {/* Settings */}
          <button className="p-2.5 rounded-xl bg-[#1A1C21] border border-[#2A2F3A] text-[#94A3B8] hover:text-[#E2E8F0] transition-colors">
      ...
      <div className="flex-1 overflow-y-auto px-8 pb-8 space-y-6" data-purpose="dashboard-content">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="flex items-center gap-2 bg-[#1A1C21] text-[#94A3B8] border border-[#2A2F3A] px-4 py-2 rounded-lg text-sm font-medium hover:text-[#E2E8F0] hover:bg-[#23262D] transition-colors">
            Eylül 2022
          </button>
        </div>
        ...
        <div className="bg-[#1A1C21] border border-[#22C55E]/30 rounded-2xl p-6 relative overflow-hidden" data-purpose="balance-card">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row justify-between items-start gap-8">
            ...
            <div className="flex-1">
              <h2 className="text-[#94A3B8] text-sm font-medium tracking-wide mb-2 uppercase">TOPLAM BAKİYE</h2>
            ...
            <div className="w-full lg:w-2/3 h-40 relative">
              ...
              {/* Y-Axis Labels */}
              <div className="absolute right-0 top-0 bottom-0 flex flex-col justify-between text-[10px] text-[#94A3B8] text-right pr-2 font-mono pb-1 z-20 bg-[#1A1C21]/80 pl-2">
                <span>₺4.000</span>
                <span>₺0</span>
                <span>-₺4.000</span>
                <span>-₺8.000</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-[#1A1C21] border border-[#2A2F3A] rounded-2xl p-6 flex items-center justify-between" data-purpose="income-card">
            <div>
              <h3 className="text-[#94A3B8] text-sm font-medium mb-1">Gelirler</h3>
          ...
          <div className="bg-[#1A1C21] border border-[#2A2F3A] rounded-2xl p-6 flex items-center justify-between" data-purpose="expense-card">
            <div>
              <h3 className="text-[#94A3B8] text-sm font-medium mb-1">Giderler</h3>
        ...
        <div className="flex items-center justify-between border-b border-[#2A2F3A] pt-2" data-purpose="tabs-section">
          <div className="flex items-center gap-6">
            ...
            <button className="pb-3 text-sm font-medium text-[#94A3B8] hover:text-[#E2E8F0] transition-colors">Giderler</button>
            <button className="pb-3 text-sm font-medium text-[#94A3B8] hover:text-[#E2E8F0] transition-colors">Faturalar</button>
          </div>
          <div className="flex items-center gap-3 pb-2">
            <button className="flex items-center gap-2 px-4 py-2 bg-[#1A1C21] border border-[#2A2F3A] rounded-lg text-sm text-[#94A3B8] hover:text-[#E2E8F0] hover:bg-[#23262D] transition-colors">
            ...
            <div className="relative">
              ...
              <i className="fa-solid fa-magnifying-glass absolute right-3 top-1/2 -translate-y-1/2 text-[#94A3B8] text-sm"></i>
            </div>
        ...
        <div className="bg-[#1A1C21] border border-[#2A2F3A] rounded-2xl flex flex-col items-center justify-center py-20" data-purpose="empty-state">
          <div className="text-[#94A3B8] mb-4 opacity-50 relative">
            {/* Sparkles */}
          ...
          <p className="text-[#94A3B8] text-sm">Bu kategori için kayıt bulunamadı.</p>
        </div>
        {/* END: Empty State */}
        ...
        <div className="bg-[#1A1C21] border border-[#2A2F3A] rounded-2xl p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4" data-purpose="smart-analysis">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-[#94A3B8] text-sm border-l-2 border-[#22C55E] pl-3 py-0.5">

...
// Add states for Manage Calendars Modal and Prompt Modal
if (!content.includes('isManageModalOpen')) {
...
// Replace the "+ Yeni Ekle" button and add "Düzenle" button next to it
const oldButtons = `<button
                  ...
                  style={{
                    padding: "8px 20px", borderRadius: 99, border: "none", cursor: "pointer", transition: "all 0.2s",
                    background: "rgba(255,255,255,0.05)", color: "#fff", fontWeight: 600, fontSize: 13, marginLeft: 4
                  }}
                >
                  + Yeni Ekle
                </button>`;
...
const newButtons = `<button
                  ...
                  style={{
                    padding: "8px 20px", borderRadius: 99, border: "none", cursor: "pointer", transition: "all 0.2s",
                    background: "rgba(239, 68, 68, 0.15)", color: "#EF4444", fontWeight: 600, fontSize: 13, marginLeft: 4
                  }}
                >
                  Düzenle
                </button>
...
if (content.includes(oldButtons)) {
    ...
    console.log("Could not find the + Yeni Ekle button block");
}

// Add Manage Calendars Modal and Prompt Modal before the last </div>
const modals = `
...
console.log("Injected modal into flowweb RandevuClient.tsx");
